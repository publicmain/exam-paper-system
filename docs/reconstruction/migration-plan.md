...
## 阶段 12 —— 生词本与错题本　🔧 **12A–12D 本地完成 · 12E staging 实机验证完成 · 12F 账号就绪 · 12G/12H/12I 首次真人验收失败，服务端与界面两半已改完**（2026-08-31），**整阶段 `USER_ACCEPTANCE_FAILED / REDESIGN_IN_PROGRESS`**
...
> · **夹具那一半还没做** —— 12H（服务端）与 12I（界面）都完了，
>   但历史卷子里仍是夹具那句占位原文、生词仍然全部被标成「教过」；
> · **用户还没有再走一遍** —— 重新验收还需要一次部署与那 23 步；
> · **阶段 13 一行未开始**；
