...
| **12** | **生词本与错题本** | 🔧 **12A 本地完成**（2026-08-30，含返工 1/2）—— `/vocab` + `/vocab/practice` + `/vocab/selftest` 三页 token-only，与课程线 / 成绩线用路由和端点分开（G-12A）。**错题本、错题重练、ExamWordSheet token-only 重写仍未开始**，整阶段未完成；本轮**未部署、未真机** | | ✓ | ✓ |
| 13 | 旧 URL 单向适配 | ⬜ | | ✓ | ✓ |
| 14 | staging 八账号实机验收 | ⬜ | | — | — |
| 15 | 灰度切换（1 → 5 → 整班） | ⬜ | | — | 开关 |
...
## 阶段 12 —— 生词本与错题本　🔧 **12A 本地完成**（2026-08-30，含返工 1/2），**整阶段仍未完成**
