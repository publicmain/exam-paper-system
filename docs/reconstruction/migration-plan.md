...
## 阶段 12 —— 生词本与错题本　🔧 **12A–12D 本地完成 · 12E staging 实机验证完成 · 12F 账号就绪 · 12G/12H/12I 首次真人验收失败，服务端与界面两半已改完 · 12J 夹具重建并部署 · 12K 重建计划 · 12L 试点最小改动上线 · 12M 真内容进库、试点开跑**（2026-08-31），**整阶段 `PILOT_RUNNING`**
