...
**生产**：仓库能证明的只有 —— `origin/main` 停在 **`b72212e`**（P1 完成登记），
本地 `main` **领先 42 个提交**，P7 / P8 / P8.5 / P9 / P9.5 / RC1 / RC1.1 全在
这些**未推送**的提交里；RC1.1 只推到过 `staging-manual-test` 分支。
**因此不得声称 RC1.1 已发布、已部署或学生每天在用。** 生产实际跑的是哪个
提交，需要部署侧证据，本仓库没有，不做断言。
