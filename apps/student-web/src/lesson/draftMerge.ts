/**
 * 打开卷子时，本地缓存与服务端答案怎么合（纯函数）。
 *
 * 从 `apps/web/src/components/exam/draftMerge.ts` **逐字搬**过来的行为
 * （S7A §1.2 第 3 项，REUSE_PURE_LOGIC）——原文件零外部依赖，这里只改了
 * 注释语言与导出类型名。既有的八条用例也一并搬进了
 * `__tests__/reading-draft-merge.test.ts`。
 *
