...
const SHOTS = [
  ...
  { id: 'today-test-pending', path: '/today', scenario: 'test_pending' },
  { id: 'today-no-reading', path: '/today', scenario: 'no_reading' },
  { id: 'today-all-deferred', path: '/today', scenario: 'all_deferred' },
